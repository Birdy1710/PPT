function approximate_derivative = backwardDifferenceDerivative(func, evaluation_point, h, order_of_accuracy)
    ...
    if order_of_accuracy == 1
        approximate_derivative = (func(evaluation_point) - func(evaluation_point - h)) / h;
    else
